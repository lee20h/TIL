...
![Virtual-Memory](/TIL/images/OS/Virtual-Memory.JPG)  
Storage에 들어가는 메모리들은  
...
![vaild-invaild](/TIL/images/OS/vaild-invaild.JPG)  
...
![Page-Table](/TIL/images/OS/Page-Table.JPG)  
Invalid한 프레임에 접근하게 되면 Page Fault가 일어난다.  

**Page Fault**  
![Page-Fault](/TIL/images/OS/Page-Fault.JPG)  
...
### FIFO 알고리즘
![Replace-FIFO](/TIL/images/OS/Replace-FIFO.JPG)  
...
### Optimal 알고리즘
![Optimal-algorithm](/TIL/images/OS/Optimal-algorithm.JPG)  
가장 이상적인 알고리즘은 앞으로의 미래를 예측해서 가장 늦게 쓰일 프레임을 대체하는 것이다. 하지만 우리는 미래를 예측할 수 없어서 이상적인 알고리즘으로만 남았다.

### LRU 알고리즘 
![LRU-algorithm](/TIL/images/OS/LRU-algorithm.JPG)  
...
![Copy-on-Write](/TIL/images/OS/Copy-on-Write.JPG)
...
![Copy-on-Write2](/TIL/images/OS/Copy-on-Write2.JPG)  
...
![Memory-Mapped](/TIL/images/OS/Memory-Mapped.JPG)    
...
리눅스에서도 지금도 쓰이고 있다.  
![Buddy-System](/TIL/images/OS/Buddy-System.JPG)  
...
![Slab-Allocation](/TIL/images/OS/Slab-Allocation.JPG)  
...
![Program-Structure](/TIL/images/OS/Program-Structure.JPG)  
