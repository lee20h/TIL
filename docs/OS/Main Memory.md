...
![Multiple-partition](/TIL/images/OS/Multiple-partition.JPG)  
...
![Swapping](/TIL/images/OS/Swapping.JPG)  
...
![Segmentation](/TIL/images/OS/Segmentation.JPG)  
...
![Logical-Paging](/TIL/images/OS/Logical-Paging.JPG)  
Paging의 논리적인 모델을 살펴보면 이러하다. 논리 메모리에서 page table을 거쳐 물리메모리로 매칭되는 방식이다.  
![Paging](/TIL/images/OS/Paging.JPG)  
...
![Free-Frames](/TIL/images/OS/Free-Frames.JPG)  
...
![Paging-table](/TIL/images/OS/Paging-table.JPG)  
...
![2-level P-T](/TIL/images/OS/2-level-P-T.JPG)  
